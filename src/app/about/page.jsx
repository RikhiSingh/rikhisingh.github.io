                    ...
                    <div className="flex flex-col gap-12 justify-center">
                        ...
                        <div className="self-end">
                            <svg width="136" height="100" viewBox="0 0 136 100" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M8 15C10.6439 17.764 11.896 21.1864 13.3333 24.7222C17.4964 34.9634 21.0182 45.4959 24.4444 56C28.9203 69.7221 33.7983 83.689 36 98" stroke="black" strokeWidth="3" stroke-linecap="round" />
                                <path d="M2.00057 48.8012C2.00057 39.5303 1.79625 32.6268 9.11168 25.4679C15.2432 19.4675 29.3365 7.37709 38.6672 13.8567C45.4482 18.5657 51.6695 36.0698 44.6672 42.6901C38.3791 48.6353 29.0175 50.1805 21.7783 54.579C17.8739 56.9513 22.1597 58.5757 24.445 59.8012C34.0562 64.955 43.0849 70.5361 50.7784 78.3568C52.9712 80.5859 55.2276 84.4147 58.0006 85.8012" stroke="black" strokeWidth="3" stroke-linecap="round" />
                                <path d="M60 65C60.6488 68.4603 62.4155 81.7077 65 83" stroke="black" strokeWidth="3" stroke-linecap="round" />
                                <path d="M61 58C59.8125 56.6641 59.9265 56 58 56" stroke="black" strokeWidth="3" stroke-linecap="round" />
                                <path d="M49.7391 6.37619C50.1482 9.03554 51.8853 11.8268 52.8746 14.2466C57.177 24.7713 60.3015 35.6896 63.8078 46.4919C66.3455 54.3102 69.3153 62.0251 71.4874 69.9578C72.079 72.1185 72.5914 74.2786 73.2959 76.3924" stroke="black" strokeWidth="3" stroke-linecap="round" />
                                <path d="M76.8949 43.1838C76.7631 44.041 76.0648 44.9342 75.6407 45.6376C73.9967 48.3644 72.3031 51.0608 70.6331 53.7716C69.9075 54.9494 69.2325 56.1556 68.5882 57.3797C67.9272 58.6357 68.1839 58.7869 69.2244 59.7608C72.0865 62.4396 75.1148 64.726 78.6035 66.5407C80.5353 67.5455 82.5827 68.3071 84.4927 69.3489C84.8941 69.5679 85.0978 69.8956 85.5652 70.0124" stroke="black" strokeWidth="3" stroke-linecap="round" />
                                <path d="M68.2247 2.28647C70.1197 5.99029 72.2756 9.54426 74.1139 13.2833C75.5304 16.1642 76.8445 19.0936 78.2854 21.9626C79.9297 25.2365 81.7021 28.4447 83.1295 31.8234C86.9497 40.866 90.382 50.0877 93.3811 59.4336C94.581 63.173 95.7155 66.9512 96.362 70.8303" stroke="black" strokeWidth="3" stroke-linecap="round" />
                                ...
                                <path d="M112.23 41.5479C113.485 43.6384 113.761 46.4247 114.484 48.7276C115.118 50.7464 115.882 52.9074 117.592 54.2715C117.872 54.4944 119.592 55.3548 119.592 54.4714" stroke="black" strokeWidth="3" stroke-linecap="round" />
                                <path d="M110.104 32.8776C110.125 33.2395 110.344 33.5138 110.431 33.8592" stroke="black" strokeWidth="3" stroke-linecap="round" />
                                <path d="M72.6416 92.5877C73.3 92.478 74.1801 91.5995 74.5865 91.279C80.2937 86.7779 85.923 82.1506 91.8906 77.9919C102.409 70.6615 113.767 65.0788 125.299 59.5608C128.196 58.175 131.172 56.9288 133.824 55.1258" stroke="black" strokeWidth="3" stroke-linecap="round" />
                            </svg>
                        </div>
